...
/**
 * AAS for the QA Device
 * 
 * @author molina, conradi
 *
 */
public class QaAAS extends DeviceAAS implements IQaAAS{

	public QaAAS(String idShort, String id, Asset asset, ProcessSubmodel processSM, ServiceSubmodel serviceSM,
			StatusSubmodel statusSM) {
